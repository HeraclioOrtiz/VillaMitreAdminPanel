/**
 * Dashboard principal para profesores - Versión simplificada
      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-base text-gray-500 max-w-lg mx-auto">
            Utiliza el menú lateral para gestionar tus estudiantes y entrenamientos
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            <div className="flex justify-center mb-3">
              <UserGroupIcon className="w-8 h-8 text-villa-mitre-600" />
            </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-500">Sesiones programadas</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-500">Rutinas asignadas</p>
          </div>
        </div>
      </div>
    </div>
